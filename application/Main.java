...
public class Main extends Application {
	...
	public void start(Stage stage) {	//start method of the application
		try {	//try the following
			...
			directory = new File("C:\\Users\\16462\\eclipse-workspace\\BreakOutTest\\application\\Music");	//lead a file path as directory
			...
			Image icon = new Image("C:\\Users\\16462\\eclipse-workspace\\BreakOutTest\\application\\Image&CSS\\Icon.png");
